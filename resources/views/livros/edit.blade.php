...
@section('content')
    ...
    <form action="{{ route('livros.update', $livro) }}" method="POST">
        ...
        <div class="row">
            ...
            <div class="col-md-4 mb-3">
                @php
                    $valorAntigo = old('valor', $livro->valor);
                ...
                @foreach ($autores as $autor)
                    <div class="form-check">
                        <input class="form-check-input"
                               ...
                               name="autores[]"
                               value="{{ $autor->codau }}"
                               @checked(in_array($autor->codau, old('autores', $livro->autores->pluck('codau')->all())))>
                ...
                @foreach ($assuntos as $assunto)
                    <div class="form-check">
                        <input class="form-check-input"
                               ...
                               name="assuntos[]"
                               value="{{ $assunto->codas }}"
                               @checked(in_array($assunto->codas, old('assuntos', $livro->assuntos->pluck('codas')->all())))>
